...
export default function Signup(){
    ...
    async function handleSignup() {
        if(email.length === 0 || password.length === 0 || username.length === 0 || confPassword.length === 0){
        ...
        <div className="w-[100vw] h-[100vh] flex items-center justify-center">
            <div className="form-wrapper w-[40%]" style={{borderRadius:'14px',padding:'6px'}}>
                ...
                <form className="flex flex-col items-center justify-center gap-6" onSubmit={(e)=>{
                    ...
                    <input className="input border-2 border-blue-500 rounded-xl" type="text" placeholder="Enter your Username" 
                ...
                <div className="text-blue-500 my-2 cursor-pointer" onClick={()=>{navigate('/Login')}}>Already have an account?</div>
